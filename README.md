My implementation of the paper "Global and Cross-view Feature Aggregation for Multi-view Clustering"
...
![Alt text]([https://github.com/Yagna24/DMCAC/blob/main/DMCAC.png](https://github.com/Yagna24/GCFAgg/blob/main/GCFAgg.png))
